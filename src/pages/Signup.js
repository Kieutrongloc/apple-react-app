                ...
                <div className="section-header">
                    <div className="section-header-nav">
                        ...
                        <div className="header-nav-item">
                            <Link style={{color:'#666'}} className="none-address-style nav-items" to="/signin">Sign In</Link>
                            <a style={{color:'#666'}} className="none-address-style" href="">Create your Apple ID</a>
                            <a style={{color:'#666'}} className="none-address-style" href="">FAQ</a>
                        </div>
                    </div>
                </div>
                    ...
                    <form id="form-signup" action="" onSubmit={submitForm}>
                        <div className="body-first">
                            <div style={{textAlign:'center'}}>
                                ...
                                <p>One Apple ID is all you need to access all Apple services.<br></br>Already have an Apple ID? <span><a style={{color:'#0070C9'}} className="none-address-style" href="">Find it here {'>'}</a></span></p>
                            </div>

                            <div>
                                <input name="first_name" className="input-half" type="text" placeholder="First name" onChange={handleInputChange} />
                                <input name="last_name" style={{marginLeft:'30px'}} className="input-half" type="text" placeholder="Last name" onChange={handleInputChange} />
                            </div>

                            <div>
                                <p style={{fontSize:'16px',color:'666',fontWeight:'bolder',paddingTop:'15px'}}>COUNTRY / REGION</p>
                                <select className="input-full country" name="country" id="country" value={formData.country} onChange={handleInputChange}>
                                    <option value="Vietnam">Vietnam</option>
                                    <option value="United State">United State</option>
                                </select>
                                <br></br>
                                <input id="datepicker" name="birthday" className="input-full" type="text" placeholder="Birthday (DD/MM/YYYY)" onChange={handleInputChange}/>                               
                            </div>

                        </div>

                        <div className="body-second">
                            <input name="email" className="input-full" type="email" placeholder="name@example.com" onChange={handleInputChange} /><br></br>
                            <label htmlFor="email" style={{fontSize:'12px',color:'#666'}}>This will be your new Apple ID.</label><br></br>
                            <input name="password" id="password" className="input-full" type="password" placeholder="Password" value={formData.password} onChange={handleInputChange} /><br></br>
                            <input name="confirm_password" id="confirm_password" className="input-full" type="password" placeholder="Confirm password" value={formData.confirm_password} onChange={handleInputChange} /><span style={{fontSize:'12px'}} id='message'>{!passwordMatch && <div style={{color: 'red'}}>Passwords do not match</div>}</span>
                        </div>

                        <div className="body-third">
                            <input name="phone" className="input-full" type="tel" placeholder="Phone number" id="phone" onChange={handleInputChange} /><br></br>
                            ...
                            <div className="third-verify">
                                <p htmlFor="verify_with" >Verify with:</p>
                                    ...
                                    <label htmlFor="Text message">Text message</label><br></br>
                                    <input type="radio" name="verify_with" defaultValue="Phone call" onChange={handleInputChange}/>
                                    <label htmlFor="Phone call">Phone call</label><br></br>
                            </div>
                        </div>
                        ...
                        <div className="body-fourth">
                            <div onChange={handleInputChange}>
                                ...
                                <label htmlFor="announcements"> Announcements</label><br></br>
                            ...
                            <div onChange={handleInputChange}>
                                ...
                                <label htmlFor="ads"> Apps, Music, TV, and More</label><br></br>
                        ...
                        <div className="body-fifth">
                            ...
                            <a className="none-address-style" href="" style={{color:'#0070C9'}}> See how your data is managed.</a>
                            </small><br></br>
