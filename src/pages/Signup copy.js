    ...
    return (
        ...
        <section>
            ...
            <div class="section-body">
                {/* <form id="form-signup" action="" onsubmit="event.preventDefault(); validateMyForm();"> */}
                <form id="form-signup" action="">
                    <div class="body-first">
                            ...
                            <div>
                                ...
                                <select class="input-full country" name="country" id="country">
                                    ...
                                    <option defaultValue="United State">United State</option>
                                </select>
                                <br></br>
                    ...
                    <div class="body-second">
                        ...
                        <label for="email">This will be your new Apple ID.</label><br></br>
                    ...
                    <div class="body-third">
                        ...
                        <div class="third-verify">
                            <p for="verify_with">Verify with:</p>
                                <input type="radio" name="verify_with" defaultValue="Text message" checked/>
                                <label for="Text message">Text message</label><br></br>
                                <input type="radio" name="verify_with" defaultValue="Phone call"/>
                    ...
                    <div class="body-fourth">
                        <div>
                            {/* <!-- <input type="hidden" name="announcements" defaultValue="Not subcribed"> --> */}
                            <input type="checkbox" name="announcements" defaultValue="Subcribed" checked/>
                        ...
                        <div>
                            {/* <!-- <input type="hidden" name="ads" defaultValue="Not subcribed"> --> */}
                            <input type="checkbox" name="ads" defaultValue="Subcribed" checked/>
...
{/* <label style={{fontSize:'14px'},{color:'#666'}} for="email">This will be your new Apple ID.</label><br></br> */}